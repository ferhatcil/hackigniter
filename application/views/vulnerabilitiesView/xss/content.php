    ...
    <div class="col-md-12">
        <div class="card">
            <ul class="nav nav-tabs" data-bs-toggle="tabs">
                <li class="nav-item">
                    <a href="#tabs-home-17" class="nav-link active" data-bs-toggle="tab">XSS (Cross Site Scripting)</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tabs-profile-17">
                        <code class="language-scss">
                            Admin kullanıcınısı gizli sekmenizde açın, user kullanıcısı ile oluşturacağınız bir destek talebi ile sunucuya php dosyası yüklemeye çalışın.
                        </code>
                    </div>
                </div>
            </div>
